...
//continue button function
    const handleRegistration=(e)=>{
        ...
        if (!rPassword){
            ...
            if(rPassword !== password){
                setErrRPassword("Password not matched")
            }
        }
        if (username && email && emailValidation(email) && password && password.length >= 6 && rPassword && rPassword === password){
  ...
  return (
    ...
    <div className='w-full bg-gray-100 pb-10'>
        ...
        <p className='text-xs text-black leading-4 mt-4'>By creating an account, you agree to ReactMart <span className='text-blue-600'>Conditions of use</span> and <span className='text-blue-600'>Privacy Notice.</span></p>
