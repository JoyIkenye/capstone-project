  ...
  return (
    ...
    <form className='w-[350px] mx-auto flex flex-col items-center'>
     ...
     <img className='w-32 p-2' src={logo} alt='logo'/>
      ...
      <p className='text-xs text-black leading-4 mt-4'>By continuing, you agree to ReactMart <span className='text-blue-600'>Conditions of use</span> and <span className='text-blue-600'>Privacy Notice.</span></p>
      ...
      <p className='w-full text-xs text-gray-600 mt-4 flex items-center'>
       ...
       <span className='w-1/3 text-center'>New to ReactMart?</span> 
       <span className='w-1/3 h-[1px] bg-zinc-400 inline-flex' ></span>
      </p>
      <Link className='w-full' to="/registration">
      <button  className='w-full py-1.5 mt-4 text-sm font-normal rounded-sm bg-gradient-to t from-slate-200 to-slate-100 hover:bg-gradient-to-b border border-zinc-400 active:shadow-amazonInput'>
    ...
    <div className='w-full bg-gradient-to-t from-white via-white to-zinc-200 flex flex-col gap-4 justify-center items-center py-10'>
      ...
      <p className='text-xs text-gray-600'>© 2023, ReactMart.com, Inc. or its affiliates</p>
    </div>
    </div>
  )
}
